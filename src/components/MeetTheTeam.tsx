...
function FeatureCard({ icon: Icon, title, children, index, onInView, scheme }: FeatureCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl border bg-white/70 p-5 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-lg max-w-lg mx-auto sticky top-20 sm:top-24 md:top-28 lg:top-24 -translate-y-0 ${scheme.border}`}
      style={{
        zIndex: 20 + index,
  ...
  return (
    <section id="classa" className="relative isolate w-full py-20 scroll-mt-24 bg-[#F7FAFC]">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="relative min-h-[180vh] sm:min-h-[220vh] md:min-h-[260vh] lg:min-h-[250vh]">
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="mb-14 sticky top-16 sm:top-20 md:top-24 z-[80] bg-[#F7FAFC]/80 backdrop-blur-sm py-2"
          >
          ...
          <div className="grid grid-cols-12 items-start gap-6 md:gap-8 lg:gap-10 mt-10 md:mt-16">
            <div className="col-span-12 lg:col-span-6 sticky top-20 sm:top-24 md:top-28 lg:top-[calc(50vh+3rem)] -translate-y-0 lg:-translate-y-1/2 self-start mt-8 md:mt-16">
              <HeroVisual active={active} scheme={pastelSchemes[active]} />
            </div>
            <div className="col-span-12 lg:col-span-6">
              <div className="relative min-h-[180vh] sm:min-h-[220vh] md:min-h-[260vh] lg:min-h-[300vh]">
